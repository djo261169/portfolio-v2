...
namespace v2.Controllers
{
    public class ProjectsController : Controller
    {
        ...
        {
            var projects = db.Projects.Include(p => p.Department);
        ...
        public ActionResult Create([Bind(Include = "ProjectID,Title,URL,Story,DepartmentID")] Project project, HttpPostedFileBase UploadImage)
        {
            if (ModelState.IsValid)
            {
                if (UploadImage != null)
                {
                    ...
                    project.URL = UploadImage.FileName;
                }
